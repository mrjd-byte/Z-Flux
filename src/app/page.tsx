      ...
      <div className="relative z-10 flex flex-col min-h-screen">
        ...
        <header className="fixed top-0 inset-x-0 z-50 border-b border-white/5 bg-black/40 backdrop-blur-xl">
          <div className="mx-auto max-w-7xl px-6 h-20 flex items-center justify-between">
            ...
            <nav className="flex items-center gap-6">
              <Link href="/login" className="text-base font-medium text-zinc-400 hover:text-white transition-colors">
                Login
              </Link>
              <Link
                href="/signup"
                className="text-base font-medium text-white bg-white/10 hover:bg-white/20 px-5 py-2.5 rounded-full transition-all border border-white/5 active:scale-95"
              >
                Get Started
              </Link>
            </nav>
        ...
        <main className="flex-grow pt-20">
          ...
          <section className="relative px-6 py-24 md:py-40 flex flex-col items-center justify-center text-center max-w-5xl mx-auto">
            <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-indigo-500/10 border border-indigo-500/20 text-indigo-400 text-xs sm:text-base font-medium mb-8">
            ...
            <div className="max-w-7xl mx-auto px-6">
              ...
              <div className="grid md:grid-cols-3 gap-8 relative">
                ...
                <div className="relative z-10 flex flex-col items-center text-center">
                  ...
                  <p className="text-base text-zinc-400">Connect your accounts or manually add your recurring income sources.</p>
                </div>
                ...
                <div className="relative z-10 flex flex-col items-center text-center">
                  ...
                  <p className="text-base text-zinc-400">Let Z-Flux categorize your spending out-of-the-box with high precision.</p>
                </div>
                ...
                <div className="relative z-10 flex flex-col items-center text-center">
                  ...
                  <p className="text-base text-zinc-400">Receive custom AI recommendations to maximize your wealth growth.</p>
                </div>
              </div>
            </div>
          </section>
        ...
        {/* Footer */}
        <footer className="py-8 border-t border-white/5 text-center text-base text-zinc-500">
